...
const LEVEL_REWARDS: LevelReward[] = [
  ...
  { level: 2, title: '一歩前進', description: 'レベルアップストーリー', emoji: '🎬' },
  { level: 3, title: '継続の力', description: 'レベルアップストーリー', emoji: '💪' },
  { level: 4, title: '語彙の芽', description: 'レベルアップストーリー', emoji: '🌱' },
  { level: 5, title: 'メンバーとの絆', description: 'ストーリーカード5枚解放', emoji: '💫' },
  { level: 6, title: '挑戦者', description: 'レベルアップストーリー', emoji: '⚔️' },
  { level: 7, title: '読解の扉', description: 'レベルアップストーリー', emoji: '📚' },
  { level: 8, title: '音楽と言葉', description: 'レベルアップストーリー', emoji: '🎵' },
  { level: 9, title: '表現力', description: 'レベルアップストーリー', emoji: '✍️' },
  { level: 10, title: '信頼の証', description: 'ストーリーカード1枚解放', emoji: '🏅' },
  { level: 11, title: '飛躍', description: 'レベルアップストーリー', emoji: '🚀' },
  { level: 12, title: '多角的理解', description: 'レベルアップストーリー', emoji: '🔮' },
  { level: 13, title: '国際感覚', description: 'レベルアップストーリー', emoji: '🌍' },
  { level: 14, title: '深い理解', description: 'レベルアップストーリー', emoji: '🧠' },
  { level: 15, title: '特別な存在', description: 'ストーリーカード1枚解放', emoji: '👑' },
  { level: 16, title: '熟練', description: 'レベルアップストーリー', emoji: '🎯' },
  { level: 17, title: '創造力', description: 'レベルアップストーリー', emoji: '🎨' },
  { level: 18, title: '対話力', description: 'レベルアップストーリー', emoji: '💬' },
  { level: 19, title: '洞察', description: 'レベルアップストーリー', emoji: '👁️' },
  { level: 20, title: '世界への扉', description: 'レベルアップストーリー', emoji: '🚪' },
  { level: 21, title: '知恵の結晶', description: 'レベルアップストーリー', emoji: '💎' },
  { level: 22, title: '自在な表現', description: 'レベルアップストーリー', emoji: '🌊' },
  { level: 23, title: '達人の域', description: 'レベルアップストーリー', emoji: '⭐' },
  { level: 24, title: '伝説へ', description: 'レベルアップストーリー', emoji: '🌟' },

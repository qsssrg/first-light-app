...
export const VN_BACKGROUNDS: Record<string, VNBackground> = {
  ...
  'street-busking': {
    id: 'street-busking',
    label: '路上ライブ',
    gradient: 'linear-gradient(180deg, #ff9a56 0%, #c8703a 30%, #8a5028 60%, #3a2010 100%)',
    overlay: 'radial-gradient(ellipse at 50% 30%, rgba(255,200,100,0.15) 0%, transparent 50%)',
    imagePath: `${basePath}/backgrounds/desktop/street-busking.png`,
    mobileImagePath: `${basePath}/backgrounds/mobile/street-busking.png`,
    desktopImagePath: `${basePath}/backgrounds/desktop/street-busking.png`,
  },
  'livehouse-small': {
    id: 'livehouse-small',
    label: '小さなライブハウス',
    gradient: 'linear-gradient(180deg, #0a0a0f 0%, #1a1510 30%, #2a2015 60%, #0a0a0f 100%)',
    overlay: 'radial-gradient(ellipse at 50% 40%, rgba(255,200,100,0.1) 0%, transparent 50%)',
    imagePath: `${basePath}/backgrounds/desktop/livehouse-small.png`,
    mobileImagePath: `${basePath}/backgrounds/mobile/livehouse-small.png`,
    desktopImagePath: `${basePath}/backgrounds/desktop/livehouse-small.png`,
  },
  'conference-panel': {
    id: 'conference-panel',
    label: 'カンファレンス会場',
    gradient: 'linear-gradient(180deg, #0a0a14 0%, #101028 30%, #151540 60%, #0a0a14 100%)',
    overlay: 'radial-gradient(ellipse at 50% 30%, rgba(100,150,255,0.12) 0%, transparent 40%)',
    imagePath: `${basePath}/backgrounds/desktop/conference-panel.png`,
    mobileImagePath: `${basePath}/backgrounds/mobile/conference-panel.png`,
    desktopImagePath: `${basePath}/backgrounds/desktop/conference-panel.png`,
  },
  'taipei-venue': {
    id: 'taipei-venue',
    label: '台北のライブ会場',
    gradient: 'linear-gradient(180deg, #0a0a1a 0%, #1a0a20 30%, #2a1030 60%, #0a0a1a 100%)',
    overlay: 'radial-gradient(ellipse at 50% 50%, rgba(255,80,80,0.1) 0%, transparent 40%), radial-gradient(circle at 30% 40%, rgba(100,200,255,0.06) 0%, transparent 30%)',
    imagePath: `${basePath}/backgrounds/desktop/taipei-venue.png`,
    mobileImagePath: `${basePath}/backgrounds/mobile/taipei-venue.png`,
    desktopImagePath: `${basePath}/backgrounds/desktop/taipei-venue.png`,
  },
  'arena-stage': {
    id: 'arena-stage',
    label: 'アリーナステージ',
    gradient: 'linear-gradient(180deg, #0a0a1a 0%, #151540 30%, #1a1050 60%, #0a0a1a 100%)',
    overlay: 'radial-gradient(ellipse at 50% 20%, rgba(120,80,255,0.2) 0%, transparent 40%), radial-gradient(circle at 50% 40%, rgba(80,150,255,0.1) 0%, transparent 30%)',
    imagePath: `${basePath}/backgrounds/desktop/arena-stage.png`,
    mobileImagePath: `${basePath}/backgrounds/mobile/arena-stage.png`,
    desktopImagePath: `${basePath}/backgrounds/desktop/arena-stage.png`,
  },
  'london-bookshop': {
    id: 'london-bookshop',
    label: 'ロンドンの書店',
    gradient: 'linear-gradient(135deg, #2c1f14 0%, #3e2c1e 30%, #4a3525 60%, #2c1f14 100%)',
    overlay: 'radial-gradient(ellipse at 50% 40%, rgba(255,220,150,0.12) 0%, transparent 50%)',
    imagePath: `${basePath}/backgrounds/desktop/london-bookshop.png`,
    mobileImagePath: `${basePath}/backgrounds/mobile/london-bookshop.png`,
    desktopImagePath: `${basePath}/backgrounds/desktop/london-bookshop.png`,
  },
  'la-venue': {
    id: 'la-venue',
    label: 'LAイベントスペース',
    gradient: 'linear-gradient(180deg, #f0ebe5 0%, #e8e0d5 30%, #d4ccc0 60%, #c8bfb0 100%)',
    overlay: 'radial-gradient(ellipse at 50% 30%, rgba(255,255,255,0.15) 0%, transparent 50%)',
    imagePath: `${basePath}/backgrounds/desktop/la-venue.png`,
    mobileImagePath: `${basePath}/backgrounds/mobile/la-venue.png`,
    desktopImagePath: `${basePath}/backgrounds/desktop/la-venue.png`,
  },
  'tokyo-dome': {
    id: 'tokyo-dome',
    label: '東京ドーム',
    gradient: 'linear-gradient(180deg, #0a0a14 0%, #151525 30%, #1a1a30 60%, #0a0a14 100%)',
    overlay: 'radial-gradient(ellipse at 50% 20%, rgba(255,220,150,0.15) 0%, transparent 40%), radial-gradient(circle at 50% 50%, rgba(255,255,255,0.05) 0%, transparent 30%)',
    imagePath: `${basePath}/backgrounds/desktop/tokyo-dome.png`,
    mobileImagePath: `${basePath}/backgrounds/mobile/tokyo-dome.png`,
    desktopImagePath: `${basePath}/backgrounds/desktop/tokyo-dome.png`,
  },
};

...
export const ch4Intro: Scenario = {
  ...
  lines: [
    ...
    { type: 'dialog', character: 'boss', text: 'お前たち、何勝手にやってるんだ？ 外部の人間を独断で引き入れたらしいな。', background: 'president-office' },
    { type: 'dialog', character: 'boss', text: '英語力を高められるって根拠を見せろ。見せられなきゃ、この人には出てってもらう。', background: 'president-office' },
    { type: 'dialog', character: 'player', text: '（退場…！？ クビってこと…！？）', isInner: true, background: 'president-office' },
    { type: 'dialog', character: 'yuuki', text: '{playerName}のおかげで俺たちめちゃくちゃ成長してるのに…！', expression: 'surprised', background: 'president-office' },
    { type: 'dialog', character: 'kai', text: '…分かった。証拠を見せよう。{playerName}、俺たちの実力を見てもらうぞ。', expression: 'serious', background: 'president-office' },
    { type: 'dialog', character: 'ren', text: '…ここで引き下がるわけにはいかない。全力でいくぞ。', expression: 'serious', background: 'president-office' },
    { type: 'dialog', character: 'haruto', text: '{playerName}さん…一緒に証明しましょう。僕たちの成長を。', expression: 'default', background: 'president-office' },
    { type: 'dialog', character: 'sora', text: '…{playerName}さんを守るためにも、頑張ります。', expression: 'default', background: 'president-office' },
    { type: 'dialog', character: 'narrator', text: '――事務所のテスト。FIRST LIGHTの英語力が試される。', background: 'president-office' },
  ],
};

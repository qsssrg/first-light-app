...
export const LISTENING_QUESTIONS: ListeningQuestion[] = [
  // 英検2級型 - 短い会話
  {
    ...
    correctIndex: 1,
    explanation: '2ブロック直進、信号を左、んで右手。道案内はシンプルに聞き取れるかが勝負だな。',
  },
  {
    id: 'l-eiken2-2',
    type: 'eiken',
    ...
    correctIndex: 1,
    explanation: 'cancelledじゃなくてpostponed、延期ってことだ。ライブが延期って聞くと焦るけど、中止じゃなきゃまだマシだろ。',
  },
  {
    id: 'l-eiken2-3',
    type: 'eiken',
    ...
    correctIndex: 2,
    explanation: 'within a weekがポイントだな。「1週間以内に連絡する」。面接の結果待ちってやつだ。',
  },
  // 準一級型 - やや長い会話
  {
    id: 'l-pre1-1',
    ...
    correctIndex: 1,
    explanation: 'complete abstinenceじゃなくてmindful usage。完全にやめるんじゃなくて、うまく付き合えってことだな。…俺もギター弾いてると時間忘れるけど。',
  },
  {
    id: 'l-pre1-2',
    type: 'eiken',
    ...
    correctIndex: 2,
    explanation: 'varietyがキーワードだな。いろんな植物性食品を食べれば十分ってこと。サプリに頼らなくていい。',
  },
  // TOEFL型 - レクチャー
  {
    id: 'l-toefl-1',
    ...
    correctIndex: 1,
    explanation: '昔は「大人の脳はもう変わらない」って思われてたけど、実は違った。耳コピで新しいフレーズ覚えるたびに脳が変わってるってことだろ。',
  },
  {
    id: 'l-toefl-2',
    type: 'toefl',
    ...
    correctIndex: 1,
    explanation: '自分の利益は独り占め、ツケはみんなで割り勘。そりゃ牛増やすだろ。バンドでいうとスタジオの共有機材を雑に使うやつと同じだな。',
  },
  {
    id: 'l-toefl-3',
    type: 'toefl',
    ...
    correctIndex: 2,
    explanation: '弱いバージョンは「言語が思考に影響する」って話。英語で歌詞を読むと日本語とは違う感覚になるだろ？ まさにそれだ。',
  },
];

...
export const CHAPTERS: Chapter[] = [
  ...
  },
  {
    ...
    title: 'The TV Show',
    titleJa: 'The TV Show',
    description: 'テレビ出演が決定。ある作戦を思いつく。',
    axis: 'grammar',
    memberId: 'kai',
    stages: [
  ...
  // === Advanced Chapters (unlock after clearing all 5 basic) ===
  {
    ...
    titleJa: 'Vocab × Grammar',
    description: 'ハルトとカイのコンビが挑む。',
    axis: 'vocabulary',
    memberId: 'haruto',
    stages: [
  ...
  },
  {
    ...
    titleJa: 'Listening × Reading',
    description: 'レンとソラのコンビが挑む。',
    axis: 'listening',
    memberId: 'ren',
    stages: [
  ...
  },
  {
    ...
    titleJa: 'Writing × Grammar',
    description: 'ユウキとカイのコンビが挑む。',
    axis: 'writing',
    memberId: 'yuuki',
    stages: [
